package edu.up.citadels.game.util;
 ...
 * CitadelsPlayer at regular intervals.  It can be used, for example, in games
...
public class GameTimer {
    // the edu.up.citadels.game to send actions to
    ...
    {
        this.target = target; // initialize edu.up.citadels.game
    ...
    /**
     * The number of GameTimerActions sent to the edu.up.citadels.game since the timer
