 ...
 * CitadelssPlayer object.  Whenever a message is sent to the ProxyGame object,
...
public class ProxyGame implements Game {
    ...
    // the player associated with this edu.up.citadels.game
     ...
     * @param ipCode
     * 			the IP code of the server where the edu.up.citadels.game is hosted
     * @return
     */
    public static ProxyGame create(int portNum, String ipCode) {
        // create the edu.up.citadels.game object
     ...
     *  	edu.up.citadels.game is running
     */
    ...
    /**
     * Starts the edu.up.citadels.game. In this context, we know that the array will
