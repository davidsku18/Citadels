 ...
 * players behalf.  Most real games will subclass game.GameAction to define
 * actions that are relevant to the particular game.  A game.GameAction contains
 * the player as part of its state; this way the game always knows what
 * player sent it the action.
 * <P>
 * Several "generic" of game.GameAction classes are already defined.  These
