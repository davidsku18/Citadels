 ...
 */
        ...
        import ActionMsg.GameOverAckAction;
        import ActionMsg.MyNameIsAction;
        import ActionMsg.ReadyAction;
        import ActionMsg.TimerAction;
        import ActionMsg.GameAction;
        import player.GamePlayer;
        import InfoMsg.BindGameInfo;
        import InfoMsg.GameOverInfo;
        import InfoMsg.IllegalMoveInfo;
        import InfoMsg.NotYourTurnInfo;
        import InfoMsg.StartGameInfo;
        import GameFramework.GameTimer;
        import GameFramework.Tickable;
...
public abstract class LocalGame implements Game, Tickable {
    ...
    private void receiveMessage(Message msg) {
        if (msg.obj instanceof GameAction) { // ignore if not game.GameAction
